...
class Application_Model_QcoPdf
{
  ...
  public function createPdf($qcoId)
  {
    ...
    $qcoMain = $qco->returnMainById($qcoId);
    $qcoHour = $qco->returnHourById($qcoId);
    $qcoFleet = $qco->returnFleetById($qcoId);
    $height = 680;
